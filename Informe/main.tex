...
\doctitle{Sistemas de Control | 25.23}
\docsubtitle{TP 2}
...
\newpage
\input{Secciones/2_Sistema_a_lazo_abierto.tex}
\newpage
\input{Secciones/3_Realimentacion_lineal.tex}
\newpage
\input{Secciones/4_Comparación-Resultados.tex}
\newpage
\input{Secciones/5_Analisis_Retro-Int.tex}
\newpage
\input{Secciones/6_Justificacion_Ctrl-Int}
